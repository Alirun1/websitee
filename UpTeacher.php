...
<br>
    ...
    <input class="input2" type="text" name="tid" placeholder="Teacher ID">
...
<label for="class_id">Select Class:</label>
    <select placeholder="Select" name="class_id">
...
<footer class="footer-basic">
            ...
            <div class="social">
                ...
                <a href="ViewTeacher.php"><img src="list.png" alt=""></a>
                <a href="AddTeacher.php"><img src="bookmark.png" alt=""></a>
                <a href="DelTeacher.php"><img src="delete.png" alt=""></a>
            </div>
