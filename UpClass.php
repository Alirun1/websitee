...
<br>
    ...
    <form method="post" action="upclass.php">
        <input class="input2" type="text" name="cid" placeholder="Class ID">

        <br>
        <br>

        <input class="input1" type="text" name="namee" placeholder="Name">
...
<footer class="footer-basic">
            ...
            <div class="social">
                ...
                <a href="AddClass.php"><img src="bookmark.png" alt=""></a>
