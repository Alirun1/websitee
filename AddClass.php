...
<form name="myForm" method="post" action="AddClass.php" onsubmit="return validateForm()">

        <input class="input2" type="text" name="namee" placeholder="Class Name">

        <br>
        <br>

        <input class="input3" type="text" name="field" placeholder="Field">
...
<?php
    ...
    if (isset($_POST['Submit'])) {
        ...
        $sql = "INSERT INTO class (name, field) VALUES ('$name', '$field')";

            if (mysqli_query($link, $sql)) {
                echo "<script>New record created successfully</script>";
                } else {
                    echo "<script>Error adding record</script>";
            }
...
<small>
            ...
            <div class="social">
                ...
                <a href="ViewClass.php"><img src="list.png" alt=""></a>
                <a href="upclass.php"><img src="edit.png" alt=""></a>
                <a href="DelClass.php"><img src="delete.png" alt=""></a>
            </div>
