...
<br>
    ...
    <form method="post" action="upstudent.php">

    <input class="input2" type="text" name="sid" placeholder="Student ID">

    <br>
    <br>

    <input class="input1" type="text" name="namee" placeholder="Full Name">
...
<select class="input4" placeholder="Select" name="pid">
...
<select class="input4" placeholder="Select" name="cid">
...
<?php
    ...
    if (isset($_POST['Submit'])) {
        ...
        $sql = "UPDATE student
        SET name = '$name', email = '$email', address = '$address', pid = '$pid', cid = '$cid'
        WHERE sid = '$sid'";
